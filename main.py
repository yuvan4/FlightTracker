...
key = dotenv_values(".env")["SEATS_AERO_API_KEY"]

api_result = requests.get(f'https://api.aviationstack.com/v1/flights?access_key={key}') # requests the data from the endpoint
